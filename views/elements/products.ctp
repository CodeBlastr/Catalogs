...
?>
    <div class="indexRow">
		<div class="indexCell galleryThumb" id="galleryThumb<?php echo $catalogItem['CatalogItem']['id']; ?>">
			<?php echo $this->element('thumb', array('plugin' => 'galleries', 'model' => 'CatalogItem', 'foreignKey' => $catalogItem['CatalogItem']['id'], 'thumbSize' => 'small', 'thumbLink' => '/catalogs/catalog_items/view/'.$catalogItem['CatalogItem']['id']));  ?>
        </div>
