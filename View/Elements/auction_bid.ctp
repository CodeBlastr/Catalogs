...
<div>
<table>
	<tr><td>Current bid:</td><td><b>$<?php echo ZuhaInflector::pricify($product['ProductBid'][0]['amount']) ?></b></td></tr>
	<tr>
		<td>Your bid:</td>
		<td>
		<?php
	    ...
	    echo $this->Form->input('ProductBid.amount', array('label' => false, 'class' => 'input-small', 'placeholder' => ZuhaInflector::pricify($product['ProductBid'][0]['amount'] + 1)));
