...
?>
    <div class="indexRow">
      <div class="indexCell galleryThumb" id="galleryThumb<?php echo $catalogItem['CatalogItem']['id']; ?>"> <?php echo $this->Element('thumb', array('model' => 'CatalogItem', 'foreignKey' => $catalogItem['CatalogItem']['id'], 'thumbSize' => 'large', 'thumbLink' => '/catalogs/catalog_items/view/'.$catalogItem['CatalogItem']['id']), array('plugin' => 'galleries'));  ?> </div>
