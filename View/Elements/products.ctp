...
?>
    <div class="indexRow">
      <div class="indexCell galleryThumb" id="galleryThumb<?php echo $product['Product']['id']; ?>"> <?php echo $this->Element('thumb', array('model' => 'Product', 'foreignKey' => $product['Product']['id'], 'thumbSize' => 'medium', 'thumbLink' => '/products/products/view/'.$product['Product']['id']), array('plugin' => 'galleries'));  ?> </div>
