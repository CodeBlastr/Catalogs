...
<div class="productAdd form">
    ...
    <fieldset>
		...
		echo $this->Form->input('Product.owner_id', array('type' => 'hidden', 'value' => $this->Session->read('Auth.User.id')));
		echo $this->Form->input('Product.name');
        echo $this->Form->input('Product.price', array('placeholder' => '0.00', 'type' => 'number', 'step' => '0.01', 'min' => '0', 'max' => '99999999999')); 
	...
	<fieldset>
 		<legend class="toggleClick"><?php echo __('Does this product belong to a category?');?></legend>
			<?php echo $this->Form->input('Category', array('multiple' => 'checkbox', 'label' => __('Which categories?'))); ?>
	</fieldset>
