<?php if (!empty($products)) : ?>
	...
	<div class="products list-group" id="product<?php echo $products[$i]['Product']['id']; ?>">
		<div class="list-group-item clearfix">
	    	<div class="col-md-4"> 
	    		<?php // media will be deprecated at some point ?>
	    		<?php echo CakePlugin::loaded('Media') ? $this->Html->link($this->Media->display($products[$i]['Media'][0], array('alt' => $products[$i]['Product']['name'])), array('controller' => 'products', 'action' => 'view', $products[$i]['Product']['id']), array('escape' => false)) : $this->Html->link($this->Attachment->display($products[$i]['FileStorage'][0], array('alt' => $products[$i]['Product']['name'])), array('controller' => 'products', 'action' => 'view', $products[$i]['Product']['id']), array('escape' => false)); ?>
	      </div> 
	        <div class="col-md-8"> 
