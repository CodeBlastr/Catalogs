...
<div class="product view">
  ...
  <!-- Start child images -->
  <?php if (!empty($product['Children'][0])) : foreach ($product['Children'] as $child) : ?><div class="childrenGalleries hide" id="childGallery<?php echo $child['id']; ?>"><?php echo $this->Element('gallery', array('model' => 'Product', 'foreignKey' => $child['id']), array('plugin' => 'galleries')); ?></div><?php endforeach; endif; ?>
  <!-- End child images -->
