...
?>
    <tr<?php echo $class;?>>
      ...
      <td class="actions"><?php echo $this->Html->link(__('View', true), array('action' => 'view', $catalog['Catalog']['id'])); ?> <?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $catalog['Catalog']['id'])); ?> <?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $catalog['Catalog']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $catalog['Catalog']['id'])); ?></td>
    </tr>
    <?php endforeach; ?>
  </table>
</div>
