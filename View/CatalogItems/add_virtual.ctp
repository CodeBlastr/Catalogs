...
<div class="catalogItemAdd form">
	...
	<fieldset>
    	...
    	<?php
			echo $this->Form->input('CatalogItem.model', array('options' => array('Webpage' => 'Webpage'), 'empty' => true, 'value' => 'Webpage'));
			#echo $this->Form->input('CatalogItem.foreign_key', array('empty' => true));
			echo $this->Form->input('CatalogItem.is_virtual', array('checked' => true));
