...
<?php echo $this->Form->create('CatalogItemBrand', array('enctype'=>'multipart/form-data'));?>
	...
	<?php
		...
		echo $this->Form->input('CatalogItemBrand.description', array('type' => 'richtext', 'label' => 'Promotional copy for this brand?', 'ckeSettings' => array('buttons' => array('Source','Bold','Italic','Underline','FontSize','TextColor','BGColor','-','NumberedList','BulletedList','Blockquote','JustifyLeft','JustifyCenter','JustifyRight','-','Link','Unlink','-', 'Image'))));
