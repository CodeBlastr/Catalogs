<?php
App::uses('CatalogItem', 'Catalogs.Model');

/**
 * CatalogItem Test Case
 *
 */
 ...
 */
	public function testAdd() {
      ...
      // This test is mimicing catalog/catalog_items/update >> $this->CatalogItem->add($data, $this->Auth->user('id'))
      $ret = $this->CatalogItem->add($testData);
      $this->assertTrue($ret);
      ...
      $addedItem = $this->CatalogItem->find('first', array(
              'conditions' => array(
                  'CategorizedOption.foreign_key' => $this->CatalogItem->id
              )
          ));
